...
export function test_pathfinder() {
    const pos_A = Point(307.18541941905903, -201.68673515682875);
    const pos_A1 = Point(313.18541941905903, -195.68673515682875);
    const pos_A2 = Point(311.18541941905903, -188.68673515682875);
    const obst_A1 = Segment(Point(276.266667, -206.8333), Point(300.4667, -204.8667));
    const obst_B1 = Segment(Point(300.4667, -204.8667), Point(298.4, -110.3333));
    const targ_A = Point(292.6916370903421, -212.91223555276247);
    const targ_A1 = Point(294.6916370903421, -208.91223555276247);
    const test_data = [
    ...
    const ML = MovementLogic(settings);
