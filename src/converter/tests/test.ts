...
import { NodeData, NodeType } from "../convert_types";
import { DefoldData, parseScene } from "../scene_parser";
import { IBaseEntityData, IObjectTypes } from '../../render_engine/types';


export function convert_scene(data: IBaseEntityData[]) {
    ...
    console.log("CONVERTED SCENE: ", result);
    ...
    //             fs.writeFile(`src/converter/tests/test_project/${file.name}.collection`, file.data, (err: NodeJS.ErrnoException | null) => {
    //                 if (err) console.error(err);
    //                 else console.log(`Succeful created ${file.name}.collection`);
    //             });
    //             break;
    //         case DefoldType.GO:
    //             fs.writeFile(`src/converter/tests/test_project/${file.name}.go`, file.data, (err: NodeJS.ErrnoException | null) => {
    //                 if (err) console.error(err);
    //                 else console.log(`Succeful created ${file.name}.go`);
    //             });
    //             break;
    //         case DefoldType.GUI:
    //             fs.writeFile(`src/converter/tests/test_project/${file.name}.gui`, file.data, (err: NodeJS.ErrnoException | null) => {
    //                 if (err) console.error(err);
    //                 else console.log(`Succeful created ${file.name}.gui`);
    //             });
    //             break;
    //         case DefoldType.ATLAS:
    //             fs.writeFile(`src/converter/tests/test_project/${file.name}.atlas`, file.data, (err: NodeJS.ErrnoException | null) => {
    //                 if (err) console.error(err);
    //                 else console.log(`Succeful created ${file.name}.atlas`);
    //             });
    //             break;
    //         case DefoldType.FONT:
    //             fs.writeFile(`src/converter/tests/test_project/${file.name}.font`, file.data, (err: NodeJS.ErrnoException | null) => {
    //                 if (err) console.error(err);
    //                 else console.log(`Succeful created ${file.name}.font`);
    //             });
    //             break;
    //         case DefoldType.SPINE:
    //             fs.writeFile(`src/converter/tests/test_project/${file.name}.spinescene`, file.data, (err: NodeJS.ErrnoException | null) => {
    //                 if (err) console.error(err);
