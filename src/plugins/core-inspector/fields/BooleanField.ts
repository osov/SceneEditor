/**
 * Обработчик булевых полей
 *
 * Поддерживает тип: BOOLEAN
 */
...
/** Создать обработчик булевого поля */
export function create_boolean_field_handler(): IFieldTypeHandler {
    return {
        ...
        create_binding(params: CreateBindingParams): BindingResult | undefined {
            ...
            const boolean_params = field.params as { disabled?: boolean } | undefined;
            ...
            const binding = pane_folder.addBinding(
                ...
                field.key,
                {
                    ...
                    disabled: boolean_params?.disabled,
                }
            ) as ExtendedBinding;
